        ...
        <div className=" h-[calc(100vh-65px)] overflow-x-hidden overflow-y-scroll scrollbar">
...

          {
            allUser.map((conv,index) =>{
              return(
                <NavLink to={"/"+conv?.userDetails._id} key={conv?._id} className="flex items-cente gap-2 py-3 px-2 border border-transparent hover:border-primary rounded hover:bg-stone-100 cursor-pointer ">
                  <div>
                      <Avatar
